...
import { ChevronLeft, ChevronRight, ClipboardList, Info, LayoutDashboard, Settings } from 'lucide-react';
...
const APP_NAME = 'Payroll Journal Entry';

const navItems: NavItem[] = [
  { to: '/', label: 'Dashboard', icon: LayoutDashboard },
  { to: '/payroll-runs', label: 'Payroll Runs', icon: ClipboardList },
